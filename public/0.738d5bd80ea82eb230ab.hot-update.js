...
var ListStore = (_dec = _mobx.action.bound, (_class = function ListStore() {
  _classCallCheck(this, ListStore);

  _initDefineProp(this, 'num', _descriptor, this);

  _initDefineProp(this, 'increment', _descriptor2, this);
}, (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'num', [_mobx.observable], {
  enumerable: true,
  initializer: function initializer() {
    return 0;
  }
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, 'increment', [_dec], {
  enumerable: true,
  initializer: function initializer() {
    var _this = this;
